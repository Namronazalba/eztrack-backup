...
<body class="p-3 m-0 border-0 bd-example bgcolor">
    ...
    <div class="container-desktop container">
        ...
        <div class="card mt-3 shadow-sm px-5 pt-5 pb-3">
            <!-- Search bar-->
            <div class="container">
            ...
            if (isset($_GET['account_id'])) {
                ...
                if (array_key_exists(4, $myArray)) {
                    echo "<div class='table-responsive mb-5'>
                        ...
                        <th style='width:300px; color:white;'>LOCATION</th>
                        <th style='width:200px; color:white;'>LAST REPORT</th>
    ...
    <?php require_once 'mobile_pages/service_task.php'; ?>
</body>
