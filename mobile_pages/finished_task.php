...
<body class="p-3 m-0 border-0 bd-example bgcolor">
     <div class="finished-task-mobile">
               ...
               <div class="container">
                    <form action="" method="GET">
                         <div class="row" style="padding: 20px 10px;">
                              <div class="col-6">
                                   <h6 class="fs-5" style="margin-bottom: -1px;">From Date:</h6>
                                   <input type="date" name="from_date" class="form-control mb-2 text-center fs-6 fw-bold" value="<?= (isset($_GET['from_date'])) ? $_GET['from_date'] : '' ?>">
                              </div>
                              <div class="col-6 mb-2">
                                   <h6 class="fs-5" style="margin-bottom: -1px;">To Date:</h6>
                                   <input type="date" name="to_date" class="form-control mb-2 text-center fs-6 fw-bold" value="<?= (isset($_GET['to_date'])) ? $_GET['to_date'] : '' ?>">
                              </div>
                              ...
                              <div class="col-12">
                                   <div class="input-group">
                                        <input type="text" name="platenum" class="form-control fs-5 text-center fw-bold" placeholder="Search plate #..." value="<?= (isset($_GET['platenum'])) ? $_GET['platenum'] : '' ?>">
                                        ...
                                        <a href="finished_task.php?done-task=<?= 1; ?>&account_id=<?= $account_id; ?>" class="btn btn-warning text-white pt-2" style="text-decoration: none;">Reset</a>
                                   </div>
                              </div>
                         </div>
                    </form>
                    ...
                    <div class="table-responsive">
                         <table class="table table-striped table-hover text-center" style="box-shadow: 0px 3px 11px rgba(0, 0, 0, 0.25);">
                              <thead style="background: #7280A5;">
                                   <tr class="text-white">
                                        <th style="line-height: 1;padding-bottom: 17px; padding-top:17px">PLATE NUMBER</th>
                                        <th style="padding-bottom: 20px;">STATUS</th>
                                        <th style="line-height: 1;padding-bottom: 17px">DATE CHECKED</th>
                                        <th style="padding-bottom: 20px;">IMAGE</th>
                              ...
                              <tbody class="font-monospace" style="vertical-align:middle">
                                   ...
                                   while ($row = $query_run_one_report->fetch_assoc()) { ?>
                                        <tr>
                                             ...
                                             <td><a href="finished_task_record.php?vid=<?= $row['vid']; ?>&account_id=<?= $account_id ?>" class="btn btn-outline-info">Record</a></td>
                                        </tr>
                                   <?php } ?>
                              <?php } else { ?>
                                   <script>
                                        alert('No data found. Go back!')
                                   </script>
                                   <div class="table-responsive">
                                        <table class="table table-striped table-hover text-center" style="box-shadow: 0px 3px 11px rgba(0, 0, 0, 0.25);">
                                             ...
                                             <tr>
                                                  <td class="fw-bold" colspan=4 style='text-align:center'>No Data!</td>
                                             </tr>
                                        </table>
                                   </div>
                              <?php } ?>
